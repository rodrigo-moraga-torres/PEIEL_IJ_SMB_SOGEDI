...
digraph sem {
  ...
  jus_ine [label='Justificación de la Desigualdad (jus_ine)']
...
rsvg_png(charToRaw(svg_chile), file = "C:/Users/romor/OneDrive/Documentos/GitHub/PEIEL_IJ_SMB_SOGEDI/output/modelo_mediacion_Chile.png")
...
```{r}
grafico_sogedi <- DiagrammeR::grViz("
digraph sem {
  graph [layout = dot, rankdir = LR]
...
# 3. Mostrar el gráfico dentro de RStudio
grafico_sogedi

# Exportar SOGEDI
svg_sogedi <- DiagrammeRsvg::export_svg(grafico_sogedi)
  rsvg::rsvg_png(charToRaw(svg_sogedi), "modelo_mediacion_SOGEDI.png")
